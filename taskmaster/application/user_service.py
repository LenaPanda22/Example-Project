from taskmaster.infrastructure.logger import log_error, log_info
from taskmaster.domain.user_types import AdminUser, ReadOnlyUser, User
...
class UserService:
    ...
    def change_email(self, uid, new_email):
        ...
        if result:
            log_info("E-Mail geändert für " + str(uid))
